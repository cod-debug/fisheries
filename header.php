            ...
            <a class="navbar-brand" href="index.php?link=dashboard">
              ...
              <b class="logo-icon ps-2 ">
                ...
                <img
                  ...
                  alt="homepage"
                  class="light-logo chmsulogo "
                />
              </b>
              <!--End Logo icon -->
               <label id="side_title_text"> FPB-REVIEWER </label>
              <?php /*
              <!-- Logo text -->
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                <a
                  ...
                  href="/fisheries/index.php?link=chats"
                  id="2"
                  role="button"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                  ...
                  <ul class="list-style-none">
                    <li>
                      <div class="">
                        ...
                        <!-- Message -->
                        <a href="/fisheries/index.php?link=chats" class="link border-top">
                          <div class="d-flex no-block align-items-center p-10">
                            <span
                              class="
